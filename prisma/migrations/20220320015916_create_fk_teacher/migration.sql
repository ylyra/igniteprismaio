...
-- AlterTable
ALTER TABLE "modules" ADD COLUMN     "fk_id_teacher" TEXT,
...
-- AddForeignKey
ALTER TABLE "modules" ADD CONSTRAINT "modules_fk_id_teacher_fkey" FOREIGN KEY ("fk_id_teacher") REFERENCES "teachers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
